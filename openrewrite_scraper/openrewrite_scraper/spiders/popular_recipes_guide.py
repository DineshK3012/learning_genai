...
class OpenRewritePopularRecipesSpider(scrapy.Spider):
    name = "popular_recipe_guides"
    allowed_domains = ["docs.openrewrite.org"]
    start_urls = ["https://docs.openrewrite.org/popular-recipe-guides"]
    ...
    def parse(self, response):
        for href in response.css("a::attr(href)").getall():
            ...
            if (
                full_url.startswith("https://docs.openrewrite.org/running-recipes/popular-recipe-guides")
